      ...
      <div>
        <div className="flex flex-col  items-center justify-center relative z-[1]">
          ...
          <div className="flex gap-1">
            <span className="rounded-full border-[2px] cursor-pointer border-white p-2 hover:bg-blue-700 transition-all ease-in-out duration-500 hover:-translate-y-1 text-[#ffffff]">
            ...
            <span
              onClick={contact}
              className="rounded-full border-[2px] cursor-pointer border-white p-2 hover:bg-blue-700 transition-all ease-in-out duration-500 hover:-translate-y-1 text-[#ffffff]"
            >
              <BiMessage size={18} />
            </span>
          </div>
